...
public:
    ...
    QHBoxLayout *horizontalLayoutCoinControl7;
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        horizontalLayoutCoinControl7 = new QHBoxLayout();
        horizontalLayoutCoinControl7->setSpacing(0);
        horizontalLayoutCoinControl7->setObjectName(QString::fromUtf8("horizontalLayoutCoinControl7"));
        horizontalLayoutCoinControl7->setSizeConstraint(QLayout::SetDefaultConstraint);
        horizontalLayoutCoinControl7->setContentsMargins(-1, 5, 5, -1);

        verticalLayoutCoinControl->addLayout(horizontalLayoutCoinControl7);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 830, 166));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 IFLT", 0, QApplication::UnicodeUTF8));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 IFLT", 0, QApplication::UnicodeUTF8));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 IFLT", 0, QApplication::UnicodeUTF8));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0, QApplication::UnicodeUTF8));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 IFLT", 0, QApplication::UnicodeUTF8));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 IFLT", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
