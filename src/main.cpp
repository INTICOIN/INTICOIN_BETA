...
//void scrypt_1024_1_1_256(const char* input, char* output, uint32_t N);
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        CTransaction txNew;
        txNew.nTime = 1524547235;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 504365055 << CBigNum(42) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        block.nVersion = 1;
        block.nTime    = 1524547235;
        //block.nBits    = 0;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6223633;
...
//// debug print
       assert(block.hashMerkleRoot == uint256("0x1e955654b76f42e436728bd3f86bfecd2be40f1722cfe85cce6d0389d0bf490f"));
       block.print();
